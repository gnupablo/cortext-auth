...
if($params['driver']=='pdo_mysql'){
  ...
  try {
    ...
    $db->exec("CREATE TABLE `users_infos` ( `user_id` INT(11) UNSIGNED NOT NULL, `description` TEXT DEFAULT NULL, `location` VARCHAR(255) DEFAULT NULL, `website` VARCHAR(255) DEFAULT NULL, `birthdate` date DEFAULT NULL, `last_connexion` timestamp DEFAULT CURRENT_TIMESTAMP, PRIMARY KEY (`user_id`)) ENGINE=InnoDB DEFAULT CHARSET=utf8 ;");
