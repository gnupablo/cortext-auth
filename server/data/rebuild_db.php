...
if($params['driver']=='pdo_mysql'){
  ...
  try {
    ...
    $db->exec("CREATE TABLE `users_infos` (   `user_id` int(11) unsigned NOT NULL,   `description` text,   `website` varchar(255) DEFAULT NULL,   `birthdate` date DEFAULT NULL,   `last_connexion` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,   `city` varchar(250) DEFAULT NULL,   `country` varchar(250) DEFAULT NULL,   `institution` varchar(500) DEFAULT NULL,   `activity_domain` varchar(500) DEFAULT NULL,   `research_domain` varchar(500) DEFAULT NULL,   `authorizations` text NOT NULL COMMENT 'json formatted list of authorization, for exemple URI that the user can access' ) ENGINE=InnoDB DEFAULT CHARSET=utf8;");
  }
